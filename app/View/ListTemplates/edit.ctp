...
<?php echo $this->Form->create('ListTemplate'); ?>
	<fieldset>
		<legend><?php echo __('Edit List Template'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ListTemplate.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ListTemplate.id'))); ?></li>
