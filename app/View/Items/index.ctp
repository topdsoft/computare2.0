...
//echo $this->Html->link($item['ItemCategory']['name'],array('controller'=>'itemCategories','action'=>'view',$item['ItemCategory']['id'])); 
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Receive'), array('action' => 'receive', $item['Item']['id'],'redirect'=>$redirect)); ?>
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Item Groups'), array('controller'=>'itemGroups','action' => 'index')); ?></li>
		<li><?php echo $this->Html->link(__('Item Categories'), array('controller'=>'itemCategories','action' => 'index')); ?></li>
	</ul>
</div>
