...
<?php echo $this->Form->create('Glslot'); ?>
	...
	<?php
		...
		echo '<td>'.$this->Form->input('recAPdebit',array('label'=>'','type'=>'select','options'=>$glaccounts)).'</td>';
		echo '<td>'.$this->Form->input('recAPcredit',array('label'=>'','type'=>'select','options'=>$glaccounts)).'</td>';
		echo '</tr>';
		...
		echo '<td>'.$this->Form->input('payAPdebit',array('label'=>'','type'=>'select','options'=>$glaccounts)).'</td>';
		echo '<td>'.$this->Form->input('payAPcredit',array('label'=>'','type'=>'select','options'=>$glaccounts)).'</td>';
		echo '</tr>';
