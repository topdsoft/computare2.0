<?php
App::uses('SalesOrderFee', 'Model');

/**
 * SalesOrderFee Test Case
 *
 */
class SalesOrderFeeTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->SalesOrderFee = ClassRegistry::init('SalesOrderFee');
	}
